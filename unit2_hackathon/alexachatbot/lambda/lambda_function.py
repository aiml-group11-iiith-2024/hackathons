...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Hello! Welcome to the Hackathon Project. Would you like to know your zodiac sign?"
...
class CaptureZodiacSignIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTLPfdYp1MoGPQ2xBSs5QIqJGyJjl_ahKQT8iGCqKcVw6cvV2fMJUvxEfTxMcGXTQ/pub?gid=271293899&single=true&output=csv"
